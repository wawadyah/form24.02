...
const QuestionForm = ({
    ...
    // const [inputList, setInputList] = useState([{ question: '', selectedType: '', answers: [{option: '' }], required: false }]);
    ...
    //     } else if (type === 'radio') {
    //         list[index].answers.forEach((answer, index) => {
    //             answer.answer = index === answerIndex;
    //         });
    //     } else {
    ...
    //     const list = [...inputList];
    //     list[index].selectedType = selectedOption.value;
    //     setInputList(list);
    // };
